...
if __name__ == "__main__":
    ...
    parser.add_argument('-e', '--exclude', help="Exclude 'phase' or 'module'", type=str, default=None)
    ...
    parser.add_argument('-g', '--margins', help="Show margins (True or 'overlay')", type=str, default=None)
